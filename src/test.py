...
class FuncionesBasicasTest(unittest.TestCase):
    ...
    def testSPartidos(self):
        self.assertEqual(self.test.setPartido(-4,"Leganés - Getafe"),False,"La jornada debe ser entero")
        self.assertEqual(self.test.setPartido(2,"Leganés - Getafe"),True,"El partido añadido correctamente")
